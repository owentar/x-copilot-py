...
class CommandProcessorTest(unittest.TestCase):
    ...
    def test_support_ALTITUDE_SELECT_command(self):
        self._assertCommand(self.commandProcessor.parseCommand('altitude select off'), 'ALTITUDE_SELECT', 0)
        self._assertCommand(self.commandProcessor.parseCommand('altitude select on'), 'ALTITUDE_SELECT', 1)
